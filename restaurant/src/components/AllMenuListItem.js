...
const AllMenuListItem = () => {
    const menus = [
        ...
        { id: 5, name: '크리스피 베이크', img: 'twosome.jpeg', explanation: '한우 암소만을 사용하여 진하고 깔끔한 육수로 든든한 한끼를 책임지는 어쩌고 저쩌고 어쩌고 저쩌고저쩌고저쩌고', price: '9,500' },
        { id: 6, name: '크리스피 베이크', img: 'twosome.jpeg', explanation: '한우 암소만을 사용하여 진하고 깔끔한 육수로 든든한 한끼를 책임지는 어쩌고 저쩌고 어쩌고 저쩌고저쩌고저쩌고', price: '9,500' }
    ];
...
export default AllMenuListItem;